...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://icircles.app/api/convension/contacts/' . $ms_id);
                                                       ...
                                                       <div class="form_wrapper">
                                                            ...
                                                            <form method="POST" onsubmit="submitContact()">
                                                                 ...
                                                                 <div class="col-lg-12 mt-5">
                                                                      <div class="contact_btn form-contact text-end">
...
<script>
     $(document).ready(() => {
          fetch('https://icircles.app/api/convension/contacts/' + <?= $ms_id ?>)
     ...
     function submitContact() {
          ...
          $.ajax({
               url: "https://icircles.app/api/convension/contact/" + <?= $ms_id ?>,
               method: 'post',
               processData: false,
               contentType: false,
               cache: false,
